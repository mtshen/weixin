...
function paramForm(text, split = '&', split2 = '=') {
...
function buildParams(prefix, obj, traditional = commonOption.traditional, add) {
    ...
    } else if (!traditional && is(obj) === 'object')
        for (name in obj) buildParams(prefix + '[' + name + ']', obj[ name ], traditional, add);
    else
        add(prefix, obj);
}

function stringifyForm(data, traditional = false) {
    var prefix;
    var s = [];
...
module.exports = {paramForm, paramArray, buildParams, stringifyForm};